...
Check more comprehensive usage examples under the `examples/` directory. You can run our automated demo drivers:
- **Run all command demos**: `./examples/run_commands.sh`
- **Run all model demos**: `./examples/run_models.sh`
- **Run a specific model demo**: `./examples/run_models.sh efficientnet`
