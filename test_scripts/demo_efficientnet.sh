...
if has_android_device; then
    ...
    run_case "Benchmark: EfficientNet FP32 on Android" \
...
# --- Summary Report ---
echo -e "\n${BLUE}${BOLD}==================================================================${NC}"
echo -e "${BLUE}${BOLD}>>> EFFICIENTNET TEST SUMMARY${NC}"
echo -e "${BLUE}${BOLD}==================================================================${NC}"
...
echo -e "${GREEN}${BOLD}All EfficientNet CLI commands executed successfully!${NC}"
echo -e "${BLUE}${BOLD}==================================================================${NC}"
exit 0
